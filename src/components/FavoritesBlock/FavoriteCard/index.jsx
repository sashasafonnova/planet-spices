...
import { countIncrement, countDecrement, countReset, toggleIsFavorite } from '../../../redux/slices/favoritesSlice';
        ...
        <div className={styles.card}>
            <div className={styles.icons}>
                ...
                <button className={styles.favorite} onClick={() => dispatch(toggleIsFavorite(product))}>
                    <svg className={styles.favoriteAdded} width="23" height="20" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
